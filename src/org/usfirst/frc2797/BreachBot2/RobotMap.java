...
public class RobotMap {
	...
	public static void init() {
		...
		drivetrainRobotDrive = new RobotDrive(drivetrainLeftTalon1, drivetrainLeftTalon2, drivetrainRightTalon1,
				drivetrainRightTalon2);
		...
		climberClimberTalon = new Talon(8);
		...
		shooterShooterMotor1 = new Spark(4);
		LiveWindow.addActuator("Shooter", "ShooterMotor1", (Spark) shooterShooterMotor1);

		shooterShooterMotor2 = new Spark(7);
		LiveWindow.addActuator("Shooter", "ShooterMotor2", (Spark) shooterShooterMotor2);
