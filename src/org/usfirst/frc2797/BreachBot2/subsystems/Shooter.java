...
public class Shooter extends Subsystem {
	...
	private final SpeedController shooterMotor1 = RobotMap.shooterShooterMotor1;
	private final SpeedController shooterMotor2 = RobotMap.shooterShooterMotor2;
	...
	public void setAngleMotors(double triggervalue) {
		shooterMotor1.set(triggervalue);
		shooterMotor2.set(triggervalue);
	}

	public void setShooterMotors(double speed) {

		leftShooterTalon.set(speed);
		rightShooterTalon.set(speed * (-1));
